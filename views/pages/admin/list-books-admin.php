...
<main class="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 overflow-hidden">
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50/50">
                        ...
                        <th class="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Author</th>
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <?php if (empty($books)): ?>
                        <tr>
                            <td colspan="7" class="px-8 py-12 text-center text-slate-500 font-medium">
                                <i class="fas fa-book-open text-4xl mb-3 text-slate-300 block"></i>
                        ...
                        <tr class="hover:bg-slate-50/80 transition group">
                            ...
                            <td class="px-8 py-6">
                                <div class="flex items-center">
                                    <div class="w-10 h-14 bg-slate-100 rounded-lg flex-shrink-0 mr-4 overflow-hidden border border-slate-200 shadow-sm">
                                        <img src="https://imgs.search.brave.com/BaCwUxTGMVyyZXb86FY-s2C06ZMxW6dz-FQmDH8sk9c/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWFn/ZXMuZXBhZ2luZS5m/ci9pcy81NDQ5Lzk3/ODk5Mzg5NDEyNThf/MV83NS5qcGc" class="w-full h-full object-cover">
                                    </div>
                                    <span class="text-sm font-bold text-slate-900"><?= htmlspecialchars($book['title']); ?></span>
                                </div>
                            </td>
                            ...
                            <td class="px-8 py-6">
                                <?php if ($book['availability'] === 'AVAILABLE'): ?>
                                    <span class="flex items-center text-xs font-black text-green-600 uppercase tracking-wider">
                                        <span class="w-2 h-2 bg-green-500 rounded-full mr-2 shadow-[0_0_8px_rgba(34,197,94,0.4)]"></span> Available
                                    </span>
                                <?php else: ?>
        ...
        <div class="px-8 py-6 bg-slate-50/30 border-t border-slate-50 flex items-center justify-between">
            <p class="text-xs font-bold text-slate-400">Total Books: <?= count($books); ?></p>
            <div class="flex space-x-2">
                ...
                <button class="w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center text-white font-bold text-xs shadow-lg shadow-blue-200">1</button>
